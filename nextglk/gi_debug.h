...
/* gi_debug.h: Debug feature layer for Glk API.
    ...
    Adapted for NextGlk: Debug console is disabled on Spectrum Next
    due to memory constraints and lack of a separate debug console.
...
/* Uncomment if the library supports a UI for debug commands.
   ...
   On Spectrum Next, debug support is always disabled. */
#ifndef __SPECTRUM_NEXT__
#define GIDEBUG_LIBRARY_SUPPORT (1)
#else
#undef GIDEBUG_LIBRARY_SUPPORT
#endif
...
#if defined(GIDEBUG_LIBRARY_SUPPORT)
